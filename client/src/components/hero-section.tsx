      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-slide-up">
            <div className="mb-6">
              <span className="inline-flex items-center px-4 py-2 bg-primary/10 text-primary rounded-full text-sm font-medium mb-4">
              ...
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                Full-stack developer specializing in Discord bots, AI integration, and modern web applications. 
